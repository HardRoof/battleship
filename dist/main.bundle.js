...
var DOM = /*#__PURE__*/function () {
  ...
  _createClass(DOM, [{
    ...
    key: "hoverBoat",
    value: function hoverBoat(length, direction, index, color) {
      var squares = document.querySelectorAll(".strategyPage__square");
      var squaresArr = [];
      if (direction === "horizontal") {
        //dividindo 100 squares into 10 arrays, depois checar se array-barco esta contido em uma das 10 arrays
        ...
        // }
        // for (let i = 0; i < nodeListToArr.length; i++) {
      ...
      var withinBounds = squaresArr.every(function (squaresArr) {
        return squaresArr;
      });
      if (withinBounds) {
